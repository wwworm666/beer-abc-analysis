...
- Практичные инсайты без воды"""
        ...
        prompt = f"""Ты финансовый аналитик пивных баров. Проанализируй эти данные и дай практичный комментарий.

ДАННЫЕ:
{analysis_text}

ПРОАНАЛИЗИРУЙ:
1. Какие 3 товара генерируют основной доход
2. Есть ли проблемы с наценками (слишком низкие/высокие)
3. Какие товары можно развивать (аутсайдеры с потенциалом)
4. Конкретные рекомендации для увеличения выручки

ФОРМАТ:
- Максимум 800 символов
- Только конкретные цифры и факты
