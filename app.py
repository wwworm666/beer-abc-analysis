...
# Инициализируем менеджер смен (SQLite в data/shifts.db или /kultura/shifts.db)
...
@app.route('/api/schedule/roles', methods=['GET'])
...
@app.route('/api/schedule/shift', methods=['POST'])
...
@app.route('/api/schedule/shift/<int:shift_id>', methods=['PUT'])
...
@app.route('/api/schedule/shift/<int:shift_id>', methods=['DELETE'])
...
@app.route('/api/schedule/dayoff', methods=['GET'])
...
@app.route('/api/schedule/dayoff', methods=['POST'])
...
@app.route('/api/schedule/dayoff/<int:request_id>', methods=['DELETE'])
...
@app.route('/api/schedule/revenue/<date_str>', methods=['GET'])
def schedule_get_revenue(date_str):
    """Выручка по всем точкам за день."""
    return jsonify(shifts_mgr.get_revenue_for_day(date_str))


@app.route('/api/schedule/revenue/<date_str>/<int:location_id>', methods=['PUT'])
...
@app.route('/api/schedule/revenue/sync/<date_str>', methods=['POST'])
...
@app.route('/api/schedule/wishes', methods=['GET'])
def schedule_get_wishes():
    """Получить все пожелания."""
    return jsonify(shifts_mgr.get_wishes())


@app.route('/api/schedule/wishes', methods=['POST'])
