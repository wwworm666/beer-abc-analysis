...
# F-пороги в визитах за окно 12 мес: прямой пересчёт недельных порогов /discounts
# (3, 2, 0.8, 0.3 визита/нед * 52). ПРЕДВАРИТЕЛЬНЫЕ — утверждаются владельцем
# по реальному распределению (Фаза 5 плана, docs/guests.md).
RFM_F_THRESHOLDS = (156, 104, 42, 16)       # F5 >=156, F4 >=104, F3 >=42, F2 >=16, F1 <16
