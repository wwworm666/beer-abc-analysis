...
- **2026-08-11** — Добавлены уроки: замер стоимости запроса вместо оценки по коду (год OLAP), пустой ответ OLAP не равен ошибке, один дефолт на один параметр, мёртвый JS-модуль заменять заглушкой а не удалять.
