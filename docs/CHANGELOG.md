...
В модалке создания/редактирования плана многие метрики вводились руками, хотя выводятся из других, — риск «магических чисел» и рассинхрона с фактом. Сведено к 9 ручным метрикам, 7 считаются автоматически по тем же формулам, что и факт.

**Что:**

- Из ручного ввода в авто-расчёт переведены: **чеки** (`= выручка / средний чек`), **доля кухни** (`= 100 − розлив − фасовка`), **прибыль** (`= выручка − Σ себестоимость_кат`, где `себестоимость_кат = выручка_кат / (1 + наценка_кат/100)`). Поля стали `readonly` с бейджем «авто».
