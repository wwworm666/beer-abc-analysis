...
- [`routes/salary.py`](../../routes/salary.py) — ручные корректировки ЗП + экспорт в Excel
- [`core/salary_export.py`](../../core/salary_export.py) — сборка .xlsx в формате эталонной таблицы
