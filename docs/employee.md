...
```
Премия = 500 ₽ × (смены − дни_без_кассы)
```
...
- Нюанс: за месяцы ДО ввода кассовой дисциплины кассы в графике нет → премия
  «передача смены» за такие месяцы обнулится. Актуально для расчёта текущих/будущих
  месяцев.
