...
```
расчёт  = смены × тариф                  (формула в файле)
оф.     = IF(смены>0; 15 × тариф; 0)     (фикс 15 смен = 10 500 — правило владельца)
мосты   = ручная надбавка бухгалтера     (единственная ручная ячейка)
