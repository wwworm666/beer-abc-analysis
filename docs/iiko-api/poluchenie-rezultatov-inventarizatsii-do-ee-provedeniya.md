* [Тело запроса](/articles/api-documentations/poluchenie-rezultatov-inventarizatsii-do-ee-provedeniya/a/h3_1150399349)
* [Что в ответе](/articles/api-documentations/poluchenie-rezultatov-inventarizatsii-do-ee-provedeniya/a/h3_501454233)
* [Пример запроса и результат](/articles/api-documentations/poluchenie-rezultatov-inventarizatsii-do-ee-provedeniya/a/h3_781199665)

Версия iiko: 5.1

| ![POST Request](/resources/Storage/api-documentations/http_request_post.png) | https://host:port/resto/api/documents/check/incomingInventory |
| --- | --- |
...
Структура *incomingInventoryDto*
 [+] [XSD Инвентаризации](javascript:void%280%29)
 [-] [XSD Инвентаризации](javascript:void%280%29)
