...
**Нажать кнопку "Edit" (справа вверху)**

Обновить/добавить следующие переменные:

| Key | Value | Действие |
|-----|-------|----------|
| `IIKO_SERVER` | `first-federation.iiko.it` | Обновить (убрать os.getenv) |
| `IIKO_PORT` | `443` | Добавить новую |
| `IIKO_LOGIN` | `claude544` | Добавить новую |
| `IIKO_PASSWORD` | `ApiPass2024!` | Добавить новую |

**Важно:** Удалить старые переменные с префиксом `IIKO_API_*` если они есть — код использует `IIKO_LOGIN`, не `IIKO_API_LOGIN`.
