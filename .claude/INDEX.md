...
├── Анализ проливов (/draft)     → draft.md
...
| [docs/draft.md](../docs/draft.md) | **Анализ проливов** — `/draft`: литры из проводок iiko (не из названий), строка = кег, баланс кегов с потерями, формулы ABC/XYZ | ✅ |
| [docs/draft-beer-errors.md](../docs/draft-beer-errors.md) | Ошибки анализа разливного — про прежний расчёт по названиям (`core/draft_analysis.py`, ещё живёт в месячном отчёте и /waiters) | История |
